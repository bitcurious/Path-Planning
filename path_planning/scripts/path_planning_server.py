...
import rospy
from pp_msg.srv import PP_Plugin, PP_PluginResponse
...
from algorithms.rrt import rrt_algorithm
...
def make_plan(req):
  ...
  path, previous_plan_variables = dijkstra(start_index, goal_index, width, height, costmap, resolution, origin, viz, previous_plan_variables)
...
if __name__ == '__main__':
  ...
  make_plan_service = rospy.Service("/move_base/SrvClientPlugin/make_plan", PP_Plugin, make_plan)
